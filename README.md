...
| [ZOOMV: TEMPORAL ZOOM-IN FOR EFFICIENT LONG VIDEO UNDERSTANDING](https://openreview.net/pdf?id=Spg6FCsmyc) | 2025-10 | N/A |
| [TIMESEARCH-R: ADAPTIVE TEMPORAL SEARCH FOR LONG-FORM VIDEO UNDERSTANDING VIA SELF-VERIFICATION REINFORCEMENT LEARNING](https://openreview.net/pdf/4eab1126e5732a5c9fb392076359d4afb5965c69) | 2025-10 | [Time-Search/TimeSearch-R](https://github.com/Time-Search/TimeSearch-R) ![GitHub Repo stars](https://img.shields.io/github/stars/Time-Search/TimeSearch-R?style=social) |
| [VIDEOZOOMER: REINFORCEMENT-LEARNED TEMPORAL FOCUSING FOR LONG VIDEO REASONING](https://openreview.net/pdf?id=ARHCFvgx6G) | 2025-10 | N/A |
...
| [LOVE-R1: Advancing Long Video Understanding with an Adaptive Zoom-in Mechanism via Multi-Step Reasoning](https://arxiv.org/pdf/2509.24786)      | 2025-09      | [HumanMLLM/LOVE-R1](https://github.com/HumanMLLM/LOVE-R1) ![GitHub Repo stars](https://img.shields.io/github/stars/HumanMLLM/LOVE-R1?style=social)                                                                  |
...
| [REWATCH-R1: BOOSTING COMPLEX VIDEO REASONING IN LARGE VISION-LANGUAGE MODELS THROUGH AGENTIC DATA SYNTHESIS](https://arxiv.org/pdf/2509.23652) | 2025-09 | [alibaba/ReWatch-R1](https://github.com/alibaba/ReWatch-R1) ![GitHub Repo stars](https://img.shields.io/github/stars/alibaba/ReWatch-R1?style=social) |
...
| [OmAgent: A Multi-modal Agent Framework for Complex Video Understanding with Task Divide-and-Conquer](https://arxiv.org/pdf/2406.16620)          | 2024-06      | [om-ai-lab/OmAgent](https://github.com/om-ai-lab/OmAgent) ![GitHub Repo stars](https://img.shields.io/github/stars/om-ai-lab/OmAgent?style=social)                                                                                                                                                                                                                                            |
...
| Paper                                                                                                                                             | Release Date | Github                                                                                                                                                                                                 |
| ------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Does Understanding Inform Generation in Unified Multimodal Models? From Analysis to Path Forward](https://arxiv.org/pdf/2511.20561.pdf)                       | 2025-11      | [yangluo7/V-ReasonBench](https://github.com/PKU-YuanGroup/UniSandBox) ![GitHub Repo stars](https://img.shields.io/github/stars/PKU-YuanGroup/UniSandBox?style=social)                                     |
